...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="x_panel">
                <div class="x_content">
                    <form class="" action="{{ route('unity.store') }}" method="post">
                        @method('POST')
                        @csrf
                        <span class="section">CREACION UNIDAD DE MEDIDA</span> 
                        <!--{{ $user=session('user') }}-->
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input class="form-control" class='optional' name="year" type="text">
                            </div>
                        </div>
                        <div class="field item form-group">
