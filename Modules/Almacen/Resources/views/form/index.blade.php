        ...
        <div class="title_right">
            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                <div class="input-group">
                    <a  href="{{ route('form.create') }}" class="btn btn-round btn-success btn-block"><i class="fa fa-plus"></i> Nuevo</a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>3/03/2020</td>
                                            <td>VAGONETA 3027-TRL IDH</td>
                                            <td>EN PROGRESO</td>
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-4" style="text-align: center"><a href=""><i class="fa fa-eye"></i></a></div>
                                                    <div class="col-md-4" style="text-align: center"><a href=""><i class="fa fa-edit"></i></a></div>
                                                    <div class="col-md-4" style="text-align: center"><a href=""><i class="fa fa-eye"></i></a></div>
                                                </div>
